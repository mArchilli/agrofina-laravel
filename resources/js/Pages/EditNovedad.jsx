        ...
        <>
            ...
            <div className="min-h-screen relative overflow-hidden bg-white">
                ...
                <main className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="mb-8">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                            <div className="flex-1">
                                ...
                                <p className="text-gray-600">Modifica la información de la novedad: <span className="font-semibold text-emerald-700">{novedad?.titulo || 'Sin título'}</span></p>
                            </div>
                            <Link
                                href={route('admin.novedades.index')}
                    ...
                    {/* Banner informativo */}
                    <div className="mb-6 p-4 backdrop-blur-xl bg-blue-50/80 border-2 border-blue-200/60 rounded-2xl shadow-lg">
                        <div className="flex items-start gap-3">
                            <svg className="w-6 h-6 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                            </svg>
                            <div className="flex-1">
                                <h3 className="text-sm font-bold text-blue-900 mb-2">Información Actual</h3>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-blue-900 font-semibold">{novedad?.imagenes?.length || 0}</span>
                                    </div>
                                    <div>
                                        <span className="text-blue-700 font-medium">Archivos actuales:</span>{' '}
                                        <span className="text-blue-900 font-semibold">{novedad?.archivos?.length || 0}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {novedad?.imagenes && novedad.imagenes.length > 0 && (
                                <div className="mt-4">
                                    ...
                                    <p className="text-xs text-amber-600 mt-3 flex items-start gap-1 bg-amber-50/50 rounded-lg p-2">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-800 mb-2">
                                    {novedad?.imagenes && novedad.imagenes.length > 0 ? 'Reemplazar Imágenes' : 'Imágenes'}
                                </label>
                                        ...
                                        <ul className="space-y-2">
                                            {novedad.archivos.map((archivo, index) => (
                                                <li key={index} className="flex items-center gap-3 p-2 hover:bg-emerald-50/50 rounded-lg transition-colors">
                                                    ...
                                                    <span className="text-sm text-gray-700 font-medium flex-1">{archivo.nombre}</span>
                                                    <a
                                                        href={archivo.path}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="text-emerald-600 hover:text-emerald-700 text-xs font-semibold px-3 py-1 rounded-lg hover:bg-emerald-50 transition-all"
                                                    >
                                                        Ver
                                                    </a>
                                                </li>
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-800 mb-2">
                                    {novedad?.archivos && novedad.archivos.length > 0 ? 'Reemplazar Archivos (PDFs)' : 'Archivos (PDFs)'}
                                </label>
                                <div className="backdrop-blur-xl bg-white/80 border-2 border-emerald-200/60 rounded-xl p-4 shadow-lg">
                                    <input
                                        type="file"
                            ...
                            <div className="flex flex-col-reverse sm:flex-row gap-4 pt-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-lime-600 px-6 py-3 font-semibold text-white shadow-lg hover:from-emerald-700 hover:to-lime-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-105"
                                >
                                    {processing ? (
                                        <>
