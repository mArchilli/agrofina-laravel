...
export default function EditCategoria({ categoria }) {
        ...
        <>
            ...
            <div className="min-h-screen relative overflow-hidden bg-white">
                ...
                <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    {/* Información Actual */}
                    <div className="mb-8 animate-fadeIn">
                        <div className="backdrop-blur-2xl bg-blue-50/60 border-2 border-blue-200/40 rounded-2xl shadow-xl p-6">
                            <h3 className="text-sm font-semibold text-blue-900 mb-3">Información Actual</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    <span className="text-blue-700 font-medium">Productos asociados:</span>{' '}
                                    <span className="text-blue-900 font-bold">{categoria.productos_count || 0}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 animate-fadeIn">
                        ...
                        <div className="backdrop-blur-2xl bg-white/60 border-2 border-emerald-200/40 rounded-2xl shadow-xl overflow-hidden">
                            <div className="px-6 py-4 bg-gradient-to-r from-emerald-500/10 to-lime-500/10 border-b-2 border-emerald-200/40">
                                ...
                                <p className="text-sm text-gray-600 mt-2 ml-13">Actualiza la información de esta categoría</p>
                            </div>
