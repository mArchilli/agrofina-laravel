                            ...
                            {filteredArboles.length > 0 ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {filteredArboles.map((arbol) => (
                                        <div key={arbol.id} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                                            <div className="p-6">
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="mt-2 text-sm font-medium text-gray-900">
                                        {searchTerm ? 'No se encontraron árboles de recomendación' : 'No hay árboles de recomendación'}
                                    </h3>
