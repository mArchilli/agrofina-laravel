                    ...
                    {filteredCategorias.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fadeIn">
                            {filteredCategorias.map((categoria) => (
                                <div 
                                    key={categoria.id} 
                                    className="backdrop-blur-2xl bg-white/60 border-2 border-emerald-200/40 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 overflow-hidden"
                                >
                                    <div className="p-6">
                                        ...
                                        <div className="flex gap-3 pt-4 border-t-2 border-emerald-200/40">
                                            <Link
                                                href={route('admin.categorias.edit', categoria.id)}
                                                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 border-2 border-emerald-600 text-emerald-700 font-semibold rounded-xl hover:bg-emerald-50 transition-all duration-300 hover:scale-105 shadow-lg"
                                            >
                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 font-semibold rounded-xl transition-all duration-300 shadow-lg ${
                                                    categoria.productos_count > 0
                                                        ? 'border-2 border-gray-300 text-gray-400 bg-gray-100 cursor-not-allowed'
                                                        : 'border-2 border-red-600 text-red-700 hover:bg-red-50 hover:scale-105'
                                                }`}
