                        ...
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                            <div className="flex items-center space-x-4">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-sm font-medium text-gray-900">Información de la Categoría</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-200">
                                ...
                                <p className="text-sm text-gray-600 mt-1">Información básica para organizar tus productos</p>
                            </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                                ...
                                <p className="text-sm text-gray-600 mt-1">Tips y consideraciones sobre las categorías</p>
                            </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        ...
                                        <ul className="text-sm text-gray-600 space-y-2">
                                            ...
                                            <li className="flex items-start">
                                                <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                                Agrega una descripción informativa
                                            </li>
                                            <li className="flex items-start">
                                                <span className="w-1.5 h-1.5 bg-green-500 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="text-sm text-gray-600 space-y-2">
                                            ...
                                            <li className="flex items-start">
                                                <span className="w-1.5 h-1.5 bg-blue-500 rounded-full mt-2 mr-2 flex-shrink-0"></span>
                                                Puedes editarla después de crearla
                                            </li>
                                        </ul>
                                    </div>
                                </div>
