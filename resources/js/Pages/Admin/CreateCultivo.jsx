...
export default function CreateCultivo() {
    ...
    const handleSubmit = (e) => {
        ...
        post(route('admin.cultivos.store'), {
            onSuccess: () => {
                reset();
            },
        });
                ...
                <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            ...
                            <p className="text-gray-600">Agrega un nuevo cultivo a tu catálogo</p>
                        </div>
                        <Link
                    ...
                    <div className="mb-6 backdrop-blur-2xl bg-white/60 border-2 border-emerald-200/40 rounded-2xl shadow-xl p-4">
                        <div className="flex items-center">
                            <div className="flex items-center">
                                ...
                                <span className="ml-3 text-base font-semibold text-gray-800">Información del Cultivo</span>
                            </div>
                        </div>
                    </div>
